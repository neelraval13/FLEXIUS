...
import { updateCardioStretching, deleteCardioStretching } from "@/app/actions";
...
const CardioStretchingListItem: React.FC<CardioStretchingListItemProps> = ({
  item,
  equipment,
  categoryOptions,
  isEditing,
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      try {
        await updateCardioStretching(item.id, {
          name: trimmedName,
  ...
  const handleDelete = async () => {
    await deleteCardioStretching(item.id);
  };
...
export default CardioStretchingListItem;
